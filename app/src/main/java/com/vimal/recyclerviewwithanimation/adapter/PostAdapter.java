 ...
 */
package com.vimal.recyclerviewwithanimation.adapter;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.MyView> {
    ...
    public PostAdapter(Context context, List<String> horizontalList) {
...
//        });
        ...
        int height = getRandomIntInRange(200, 400);

        holder.mainlay.getLayoutParams().height = height;
